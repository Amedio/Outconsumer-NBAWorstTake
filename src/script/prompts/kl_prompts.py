...
⚡️ Rayo de Barcelona (@RayodeBarcelona), club presidido por Spursito (@Spursito)
🔥 Saiyans FC "los sayans" (@Sayans_FC), club presidido por Gref "no siempre gana" (@TheGrefg)
🧢 Jijantes FC (@JijantesFC), club presidido por Gerard Romero "Romero" (@JijantesFC)
⚔️ xBuyer Team (@xBuyer_Team), club presidido por los 2 hermanos xBuyer, xBuyer (@1996Javi) y minibuyer (@ericruiiz)
🪵 Los Troncos FC (@LosTroncosFC_), club presidido por el streamer Perxitaa (@Perxitaa)
🦁 Ultimate Móstoles "último Móstoles" (@UltMostoles), club presidido por el youtuber DjMaRiiO (@DjMaRiiO)
💪 Aniquiladores (@AniquiladoresFC), club presidido por el streamer Juan Guarnizo "juaniquilador" (@JuanSGuarnizo)
🤟🏻 KUNisports (@kunisport), club presidido por el ex-futbolista argentino Kun Agüero "el Kun" (@kunisport)
🐷 Porcinos FC "la porcineta" (@PorcinosFC), club presidido por el presi de España, Don Ibai Llanos "Dubai Llanos" (@IbaiLlanos)
